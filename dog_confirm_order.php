<?php
include 'dog_paymentdataconnect.php';
...
<div class="navbar">
        ...
        <a href="adoptioncategory.php">About</a>
    ...
    <div class="container">
        ...
        <div class="detail">
            ...
            <span><?php echo $_GET['dogId']; ?></span>
        </div>
        <div class="detail">
            <strong>Dog Name:</strong>
            <span><?php echo $_GET['dogName']; ?></span>
        </div>
        <div class="detail">
            <strong>Price:</strong>
            <span><?php echo $_GET['dogPrice']; ?></span>
        </div>
